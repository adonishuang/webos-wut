...
var zh_windowCount = 0,
  ...
  zh_deskIcon = [
    [
      ...
      {id: 'icon1', src: 'apps/metadata.png', title: '元数据管理', webSrc: 'apps/metadata/metadataUser/index.html'},
      {id: 'icon1', src: 'apps/database.png', title: '数据库管理', webSrc: 'apps/database/databaseUser/index.html '},
